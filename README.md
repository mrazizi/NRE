...
This is a NRE project using OpenNRE respository, the following text is copied from README.md of the original github repository (https://github.com/thunlp/OpenNRE).

This project uses nyt data and also has some modification (resolving some small bugs) of the OpenNRE code.
